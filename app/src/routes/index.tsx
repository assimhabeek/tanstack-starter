...
function App() {
  ...
  const { mutate: update } = useMutation<TodoUpdateOutput, DefaultError, TodoUpdateInput>({
  ...
  const { mutate: remove } = useMutation<TodoDeleteOutput, DefaultError, TodoDeleteInput>({
